...
CREATE TABLE IF NOT EXISTS users (
    ...
    job_profile VARCHAR(100), -- e.g. 'Data Engineer', 'Frontend Dev'
    tech_stack JSONB,         -- e.g. ['python', 'gcp', 'bigquery']
...
CREATE INDEX IF NOT EXISTS idx_risk_history_user_time ON risk_scores_history(user_id, calculated_at);
